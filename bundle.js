...
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! images/overlay.png */ "./src/images/overlay.png"), __webpack_require__.b);
...
___CSS_LOADER_EXPORT___.push([module.id, `*, *::before, *::after {
  ...
  *{
  ...
  html { height: 100%;} /*This makes gradien have no bands*/
  ...
  nav>div>button:hover{
    background-color: rgba(70, 78, 95, 0.975);
    box-shadow: 2px 1px 1px #e37682; ;
    border-radius: 10px;
  }
...
padding-right: 30px;}
  ...
  .deleteStyling,.checkStyling,.editStyling,.descriptStyling,.burgerStyling{
    min-width:70px;
    min-height: 80px;
    background-color: rgba(0,0,0,0);
  ...
  .descriptStyling:hover{
    color: rgb(166, 23, 169);
  }
  ...
  }`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;EACxB;EACA;;GAEC;EACD;IACE,SAAS;EACX;EACA;;;;GAIC;EACD;IACE,gBAAgB;IAChB,mCAAmC;EACrC;EACA;;GAEC;EACD;IACE,cAAc;IACd,eAAe;EACjB;EACA;;GAEC;EACD;IACE,aAAa;EACf;EACA;;GAEC;EACD;IACE,yBAAyB;EAC3B;EACA;;GAEC;EACD;IACE,kBAAkB;EACpB;;EAEA;IACE,qBAAqB;IACrB;EACF;EACA;IACE,qBAAqB;EACvB;;;EAGA,OAAO,YAAY,CAAC,EAAE,mCAAmC;;EAEzD;IACE;oDACgD;IAChD,2BAA2B,CAAC,wCAAwC;IACpE,YAAY;EACd;;EAEA;IACE,YAAY;IACZ,eAAe;IACf,kBAAkB;IAClB,eAAe;IACf,gBAAgB;;IAEhB,iBAAiB;IACjB,+BAA+B;IAC/B,aAAa;EACf;;;EAGA;IACE,sBAAsB;IACtB,UAAU;EACZ;;EAEA;IACE,gBAAgB;IAChB,aAAa;IACb,kBAAkB;EACpB;;EAEA;IACE,gBAAgB;IAChB,yCAAyC;IACzC,YAAY;IACZ,eAAe;IACf,kBAAkB;IAClB,mBAAmB;IACnB,YAAY;IACZ,kBAAkB;IAClB,YAAY;IACZ,oBAAoB;;EAEtB;EACA;IACE,cAAc;EAChB;;EAEA;IACE,aAAa;IACb,sBAAsB;IACtB,eAAe;;EAEjB;EACA;IACE,gBAAgB;;EAElB;;EAEA;IACE,yCAAyC;IACzC,YAAY;IACZ,eAAe;IACf,gBAAgB;IAChB,kBAAkB;IAClB,+BAA+B;IAC/B,eAAe;;EAEjB;;EAEA;IACE,yCAAyC;IACzC,+BAA+B;IAC/B,mBAAmB;EACrB;;EAEA;IACE,YAAY;EACd;;EAEA;IACE,WAAW;IACX,eAAe;EACjB;EACA;IACE,UAAU;IACV;EACF;;EAEA,aAAa,UAAU;EACvB,+BAA+B;AACjC,qBAAqB;AACrB,mBAAmB,CAAC;;;EAGlB;IACE,YAAY;IACZ,uBAAuB;IACvB,WAAW;IACX,eAAe;IACf,YAAY;IACZ,eAAe;IACf,mBAAmB;IACnB,eAAe;IACf,6BAA6B;EAC/B;;;;EAIA;IACE,SAAS;;IAET,iBAAiB;IACjB,uBAAuB;EACzB;;EAEA;IACE,SAAS;IACT,iBAAiB;IACjB,gBAAgB;IAChB,kBAAkB;EACpB;;EAEA;IACE,aAAa;IACb,mBAAmB;EACrB;;;EAGA;IACE,cAAc;IACd,gBAAgB;IAChB,+BAA+B;IAC/B,+BAA+B;;EAEjC;;EAEA;IACE,uBAAuB;EACzB;;EAEA;IACE,cAAc;EAChB;;EAEA;IACE,UAAU;EACZ;;EAEA;IACE,wBAAwB;EAC1B;;EAEA;IACE,yBAAyB;EAC3B;EACA;IACE,oCAAoC;EACtC;EACA;IACE,8BAA8B;EAChC;;EAEA;IACE,cAAc;IACd,yBAAyB;IACzB,UAAU;IACV,gBAAgB;IAChB,eAAe;IACf,gBAAgB;IAChB,mBAAmB;EACrB;EACA;IACE,aAAa;EACf;;EAEA;IACE,aAAa;IACb,uBAAuB;;EAEzB;;EAEA;IACE,YAAY;IACZ,cAAc;IACd,aAAa;IACb,mBAAmB;IACnB,yCAAyC;IACzC,YAAY;IACZ,eAAe;IACf,eAAe;IACf,SAAS;IACT,SAAS;IACT,cAAc;;EAEhB;;EAEA;IACE,sCAAsC;;EAExC;;EAEA;IACE,uBAAuB;;IAEvB,YAAY;IACZ,gBAAgB;IAChB,eAAe;IACf,aAAa;IACb,YAAY;IACZ,eAAe;IACf,sBAAsB;IACtB,mBAAmB;IACnB,6BAA6B;IAC7B,mBAAmB;IACnB,yBAAyB;EAC3B;EACA;IACE,UAAU;IACV,iBAAiB;IACjB,cAAc;IACd,eAAe;IACf,kBAAkB;EACpB;EACA;IACE,eAAe;IACf,kBAAkB;EACpB;EACA;IACE,eAAe;EACjB;;EAEA;IACE,cAAc;IACd,gBAAgB;IAChB,aAAa;IACb,uBAAuB;IACvB,UAAU;IACV,gBAAgB;IAChB;wBACoB;EACtB;;EAEA;IACE,oCAAoC;EACtC","sourcesContent":["*, *::before, *::after {\n    box-sizing: border-box;\n  }\n  /*\n    2. Remove default margin\n  */\n  * {\n    margin: 0;\n  }\n  /*\n    Typographic tweaks!\n    3. Add accessible line-height\n    4. Improve text rendering\n  */\n  body {\n    line-height: 1.5;\n    -webkit-font-smoothing: antialiased;\n  }\n  /*\n    5. Improve media defaults\n  */\n  img, picture, video, canvas, svg {\n    display: block;\n    max-width: 100%;\n  }\n  /*\n    6. Remove built-in form typography styles\n  */\n  input, button, textarea, select {\n    font: inherit;\n  }\n  /*\n    7. Avoid text overflows\n  */\n  p, h1, h2, h3, h4, h5, h6 {\n    overflow-wrap: break-word;\n  }\n  /*\n    8. Create a root stacking context\n  */\n  #root, #__next {\n    isolation: isolate;\n  }\n\n  @font-face {\n    font-family: 'ubuntu';\n    src: url('./fonts/Ubuntu-Regular.ttf') format('truetype')\n  }\n  *{\n    font-family: 'ubuntu';\n  }\n  \n\n  html { height: 100%;} /*This makes gradien have no bands*/\n\n  body{\n    background-image: url(images/overlay.png),\n    linear-gradient(45deg, #e37682 15%, #5f4d93 85%);\n    background-attachment:fixed;/*repeat new gradient on scrolling down*/  \n    height: 100%; \n  }\n\n  header{    \n    color: white;    \n    min-height: 5vw;\n    text-align: center;\n    font-size: 48px;\n    font-weight: 600;\n    \n    padding-top: 10px; \n    border: 2px solid rgba(0,0,0,0);  \n    display: flex;\n  }\n\n  \n  #headerTitle{\n    /* margin-left: 40%; */\n    width: 90%;\n  }\n\n  .todoBody{\n    min-height: 100%;\n    display: flex;\n    position: relative;\n  }\n\n  nav{\n    max-width: 200px;\n    background-color: rgba(55, 61, 73, 0.975);\n    color: azure;\n    font-size: 40px;\n    text-align: center;\n    border-radius: 20px;\n    display:none; \n    position: absolute; \n    padding:20px;\n    padding-bottom: 50px;\n    \n  }\n  .menuAppear{\n    display: block;\n  }\n  \n  .navButtons{\n    display: flex;\n    flex-direction: column;\n    margin-top: 0px;\n    \n  }\n  #projectSubheading{\n    margin-top: 80px;\n    \n  }\n\n  nav>div>button{\n    background-color: rgba(55, 61, 73, 0.975);\n    color: white;\n    font-size: 30px;\n    margin-top: 20px;\n    margin-bottom: 5px;\n    border: 1px solid rgba(0,0,0,0);\n    max-width: 100%;\n  \n  }\n\n  nav>div>button:hover{\n    background-color: rgba(70, 78, 95, 0.975);\n    box-shadow: 2px 1px 1px #e37682; ;\n    border-radius: 10px;\n  }\n\n  #projectInput{\n    width: 150px;\n  } \n\n  #projInput{\n    width: 100%;\n    font-size: 24px;\n  }\n  #projInpBtn{\n    width: 95%;\n    height:50px\n  }\n\n  .todoSection{width: 95%;\n  background-color: rgba(0,0,0,0);\npadding-bottom: 150px;\npadding-right: 30px;}\n\n\n  .todoStyle{\n    margin: 20px;\n    background-color: white;\n    width: 100%;\n    min-height:80px;\n    display:flex;\n    flex-wrap: wrap;\n    border-radius: 30px;\n    font-size: 32px;\n    justify-content: space-evenly;\n  }\n\n\n\n  .titleStyling{\n    width:60%;\n   \n    padding-top: 20px;\n    text-overflow: ellipsis;\n  }\n\n  .dateStyling{\n    width:15%;\n    padding-top: 20px;\n    min-width: 150px;\n    text-align: center;\n  }\n\n  .modifyContainer{\n    display: flex;\n    align-items: center;\n  }\n\n\n  .deleteStyling,.checkStyling,.editStyling,.descriptStyling,.burgerStyling{\n    min-width:70px;\n    min-height: 80px;\n    background-color: rgba(0,0,0,0);\n    border: 3px solid rgba(0,0,0,0);\n\n  }\n\n  .checkStyling:hover{\n    color: rgb(95, 133, 39);\n  }\n\n  .deleteStyling:hover{\n    color: #8d0010;\n  }\n\n  .editStyling:hover{\n    color:blue;\n  }\n\n  .descriptStyling:hover{\n    color: rgb(166, 23, 169);\n  }\n\n  .redAlert{\n    background-color: #fe9ca7;\n  }\n  .yellowAlert{\n    background-color: rgb(246, 246, 193);\n  }\n  .greenAlert{\n    background: rgb(185, 255, 185);\n  }\n\n  .show{\n    display: block;\n    background-color: #5f4d93;\n    width:100%;\n    padding-left: 7%;\n    font-size: 28px;\n    color: aliceblue;\n    border-radius: 30px;\n  }\n  .hide{\n    display: none;\n  }\n\n  #addTaskDiv{\n    display: flex;\n    justify-content: center;\n    \n  }\n\n  #addTaskButton{\n    width: 300px;\n    max-width: 50%;\n    height: 100px;\n    border-radius: 20px;\n    background-color: rgba(55, 61, 73, 0.975);\n    color: white;\n    font-size: 30px;\n    position: fixed;\n    bottom:5%;\n    right: 5%;\n    flex-shrink: 2;\n\n  }\n\n  #addTaskButton:hover{\n    background-color: rgba(0, 0, 0, 0.975);\n\n  }\n\n  form{\n    background-color: azure;\n    \n    width: 400px;\n    min-width: 200px;\n    min-height:80px;\n    padding: 30px;\n    display:flex;\n    flex-wrap: wrap;\n    flex-direction: column;\n    align-items: center;\n    justify-content: space-evenly;\n    border-radius: 20px;\n    background-color: #c0b9d4;\n  }\n  form>input{\n    width: 80%;\n    word-wrap: normal;\n    overflow: auto;\n    margin-top: 5px;\n    margin-bottom: 5px;\n  }\n  form>textarea{\n    margin-top: 5px;\n    margin-bottom: 5px;\n  }\n  form>button{\n    margin-top: 5px;\n  }\n\n  #formDivision{\n    max-width:100%;\n    min-width: 350px;\n    display: flex;\n    justify-content: center;\n    margin: 2%;\n    max-height:800px;\n    /* margin-left: 10%;\n    margin-right: 10%; */\n  }\n\n  .completedAlert{\n    background-color: rgb(200, 197, 197);\n  }"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   attachAddButton: () => (/* binding */ attachAddButton),
/* harmony export */   projectAddition: () => (/* binding */ projectAddition),
/* harmony export */   projectDisplay: () => (/* binding */ projectDisplay)
/* harmony export */ });
/* harmony import */ var _clearWindow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./clearWindow */ "./src/clearWindow.js");
/* harmony import */ var _displayArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./displayArray */ "./src/displayArray.js");
/* harmony import */ var _taskGenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskGenerator */ "./src/taskGenerator.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! . */ "./src/index.js");
/* harmony import */ var _addTaskButton__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addTaskButton */ "./src/addTaskButton.js");
...
const projectAddition=(arr,lib)=>{
    arr=(0,___WEBPACK_IMPORTED_MODULE_3__.projectArrayExporter)();
    const addProjectBtn=document.querySelector("#AddProject");

    const addButtonSection=document.querySelector("#projectInput");

    (0,_clearWindow__WEBPACK_IMPORTED_MODULE_0__.clearScreen)(addButtonSection);
    ...
    projInputBtn.addEventListener('click',()=>{
        if(projectInput.value==''){
            ...
            attachAddButton();
            (0,___WEBPACK_IMPORTED_MODULE_3__.addActivate)(arr,lib);
...
const projectDisplay=(arr,lib)=>{
    ...
    (0,_clearWindow__WEBPACK_IMPORTED_MODULE_0__.clearScreen)(projectButtonSection);
...
function projectActivate(arr,lib){
    ...
    localStorage.setItem('ProjectItems', JSON.stringify((0,___WEBPACK_IMPORTED_MODULE_3__.projectArrayExporter)()));
    for(let currentProject of projectBtn){
        currentProject.addEventListener('click',()=>{
            
            (0,_clearWindow__WEBPACK_IMPORTED_MODULE_0__.clearScreen)(todoSec);

            arr=(0,___WEBPACK_IMPORTED_MODULE_3__.libraryImporter)();
            
            (0,_displayArray__WEBPACK_IMPORTED_MODULE_1__.displayArray)((0,_taskGenerator__WEBPACK_IMPORTED_MODULE_2__.taskGenerate)(lib,currentProject.innerHTML));
            (0,_addTaskButton__WEBPACK_IMPORTED_MODULE_4__.addTaskButton)(); 
            arr=(0,___WEBPACK_IMPORTED_MODULE_3__.projectArrayExporter)();
            
            (0,_addTaskButton__WEBPACK_IMPORTED_MODULE_4__.addButtonActivate)(arr,lib);              
        });
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addButtonActivate: () => (/* binding */ addButtonActivate),
/* harmony export */   addTaskButton: () => (/* binding */ addTaskButton),
/* harmony export */   removeTaskButton: () => (/* binding */ removeTaskButton)
/* harmony export */ });
/* harmony import */ var _createTaskForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createTaskForm */ "./src/createTaskForm.js");
...
const addButtonActivate=(arr,lib)=>{
    ...
    (0,_createTaskForm__WEBPACK_IMPORTED_MODULE_0__.createForm)(arr,lib);          
        });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   completionActivate: () => (/* binding */ completionActivate)
/* harmony export */ });
...
function completionActivate(lib){
    ...
    for(let checker of completebtn){
        checker.addEventListener('click',()=>{
            ...
            lib=(0,___WEBPACK_IMPORTED_MODULE_0__.libraryImporter)();
            
            lib=lib.map((tasks)=>{
                if((tasks.index)==counter){
                    tasks.project='Completed';
                    (0,___WEBPACK_IMPORTED_MODULE_0__.completedStorage)(tasks);
            ...
            (0,___WEBPACK_IMPORTED_MODULE_0__.libraryUpdater)(lib);
...
/* harmony export */ });
/* harmony import */ var _addTaskButton__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addTaskButton */ "./src/addTaskButton.js");
...
const createForm=(arr,lib)=>{
    (0,_addTaskButton__WEBPACK_IMPORTED_MODULE_0__.removeTaskButton)(arr,lib);
    let todoSec=document.querySelector(".todoSection");
...
const removeForm=(arr,lib)=>{
    ...
    (0,_addTaskButton__WEBPACK_IMPORTED_MODULE_0__.addTaskButton)();
    (0,_addTaskButton__WEBPACK_IMPORTED_MODULE_0__.addButtonActivate)(arr,lib)
...
formSubmit.addEventListener('submit',function(e){
    e.preventDefault();
    (0,___WEBPACK_IMPORTED_MODULE_1__.taskCollector)(formSubmit[0].value,formSubmit[4].value,formSubmit[1].value,formSubmit[2].value,formSubmit[3].value);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   deletionActivate: () => (/* binding */ deletionActivate)
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ "./src/index.js");
...
function deletionActivate(libr){
    ...
    for(let deletor of deletebtn){
        deletor.addEventListener('click',()=>{
            ...
            libr=(0,___WEBPACK_IMPORTED_MODULE_0__.libraryImporter)();
            ...
            (0,___WEBPACK_IMPORTED_MODULE_0__.libraryUpdater)(libr);
        })
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   descriptionActivate: () => (/* binding */ descriptionActivate)
/* harmony export */ });
...
/* harmony export */ });
/* harmony import */ var _taskSorter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskSorter */ "./src/taskSorter.js");
/* harmony import */ var _deletionButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./deletionButton */ "./src/deletionButton.js");
/* harmony import */ var _completionActivator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./completionActivator */ "./src/completionActivator.js");
/* harmony import */ var _editProcess__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editProcess */ "./src/editProcess.js");
/* harmony import */ var _descriptionToggler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./descriptionToggler */ "./src/descriptionToggler.js");
...
const displayArray=(arr)=>{
    let todoSec=document.querySelector(".todoSection");
    (0,_taskSorter__WEBPACK_IMPORTED_MODULE_0__.taskSort)(arr);
    (0,_taskSorter__WEBPACK_IMPORTED_MODULE_0__.indexAssign)(arr);
    ...
    (0,_deletionButton__WEBPACK_IMPORTED_MODULE_1__.deletionActivate)(arr);
    (0,_editProcess__WEBPACK_IMPORTED_MODULE_3__.editActivate)();
    (0,_completionActivator__WEBPACK_IMPORTED_MODULE_2__.completionActivate)(arr); 
    (0,_descriptionToggler__WEBPACK_IMPORTED_MODULE_4__.descriptionActivate)();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   editActivate: () => (/* binding */ editActivate)
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ "./src/index.js");
...
const editActivate=(lib)=>{
    ...
    let todoSec=document.querySelector(".todoSection");
    let library=(0,___WEBPACK_IMPORTED_MODULE_0__.libraryImporter)();
    for(let editor of editbtn){
        editor.addEventListener('click',()=>{
            ...
            let projectArray=(0,___WEBPACK_IMPORTED_MODULE_0__.projectArrayExporter)();
...
formSubmit.addEventListener('submit',function(e){
    e.preventDefault();
    (0,___WEBPACK_IMPORTED_MODULE_0__.editTaskCollector)(formSubmit[0].value,formSubmit[4].value,formSubmit[1].value,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addActivate: () => (/* binding */ addActivate),
/* harmony export */   completedExport: () => (/* binding */ completedExport),
/* harmony export */   completedStorage: () => (/* binding */ completedStorage),
/* harmony export */   editTaskCollector: () => (/* binding */ editTaskCollector),
/* harmony export */   libraryImporter: () => (/* binding */ libraryImporter),
/* harmony export */   libraryUpdater: () => (/* binding */ libraryUpdater),
/* harmony export */   projectArrayExporter: () => (/* binding */ projectArrayExporter),
/* harmony export */   taskCollector: () => (/* binding */ taskCollector)
/* harmony export */ });
...
/* harmony import */ var _taskSorter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskSorter.js */ "./src/taskSorter.js");
/* harmony import */ var _displayArray_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./displayArray.js */ "./src/displayArray.js");
/* harmony import */ var _taskGenerator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./taskGenerator.js */ "./src/taskGenerator.js");
/* harmony import */ var _clearWindow_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./clearWindow.js */ "./src/clearWindow.js");
/* harmony import */ var _AddProject_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./AddProject.js */ "./src/AddProject.js");
/* harmony import */ var _addTaskButton_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./addTaskButton.js */ "./src/addTaskButton.js");
...
class Task{
    constructor(title,priority,dueDate,project,description,index){
        ...
        this.dueDate=(0,date_fns__WEBPACK_IMPORTED_MODULE_7__.format)(dueDate,'PP');
...
(0,_taskSorter_js__WEBPACK_IMPORTED_MODULE_1__.taskSort)(taskLibrary);
(0,_taskSorter_js__WEBPACK_IMPORTED_MODULE_1__.indexAssign)(taskLibrary);
(0,_displayArray_js__WEBPACK_IMPORTED_MODULE_2__.displayArray)(taskLibrary);
(0,_addTaskButton_js__WEBPACK_IMPORTED_MODULE_6__.addTaskButton)();
(0,_addTaskButton_js__WEBPACK_IMPORTED_MODULE_6__.addButtonActivate)(projectArray,taskLibrary);
...
homeBtn.addEventListener('click',()=>{
    pageStatus='Home';
    (0,_clearWindow_js__WEBPACK_IMPORTED_MODULE_4__.clearScreen)(todoSec);
    (0,_displayArray_js__WEBPACK_IMPORTED_MODULE_2__.displayArray)(taskLibrary);
    (0,_addTaskButton_js__WEBPACK_IMPORTED_MODULE_6__.addTaskButton)();
    (0,_addTaskButton_js__WEBPACK_IMPORTED_MODULE_6__.addButtonActivate)(projectArray,taskLibrary);
});
...
todayBtn.addEventListener('click',()=>{
    pageStatus='Today';
    (0,_clearWindow_js__WEBPACK_IMPORTED_MODULE_4__.clearScreen)(todoSec);
    (0,_displayArray_js__WEBPACK_IMPORTED_MODULE_2__.displayArray)((0,_taskGenerator_js__WEBPACK_IMPORTED_MODULE_3__.taskGenerate)(taskLibrary,pageStatus));
    (0,_addTaskButton_js__WEBPACK_IMPORTED_MODULE_6__.addTaskButton)();
    (0,_addTaskButton_js__WEBPACK_IMPORTED_MODULE_6__.addButtonActivate)(projectArray,taskLibrary);
});
...
let projectButtonSection=document.querySelector("#buttonSection2");
(0,_clearWindow_js__WEBPACK_IMPORTED_MODULE_4__.clearScreen)(projectButtonSection);
(0,_AddProject_js__WEBPACK_IMPORTED_MODULE_5__.projectDisplay)(projectArray,taskLibrary);
...
const addActivate=(arr,lib)=>{
    ...
    (0,_AddProject_js__WEBPACK_IMPORTED_MODULE_5__.projectAddition)(arr,lib);    
...
const editTaskCollector=(a,p,b,c,d,identity)=>{
    ...
    taskLibrary[editIndex].dueDate=(0,date_fns__WEBPACK_IMPORTED_MODULE_7__.format)(b,'PP');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   taskGenerate: () => (/* binding */ taskGenerate)
/* harmony export */ });
...
const taskGenerate=(arr,status)=>{
    if(status=='Home'){
        ...
        return arr.filter((task)=>(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.isToday)(task.dueDate));
    }
    else if(status=='Tomorrow'){
        return arr.filter((task)=>(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isTomorrow)(task.dueDate));
    }
    else if(status=='Completed'){
        
        return (0,___WEBPACK_IMPORTED_MODULE_0__.completedExport)();
    }
    else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   indexAssign: () => (/* binding */ indexAssign),
...
const taskSort=(arr)=>{
    ...
    for(let j=(arr.length-1);j>0;j--){
        for(let i=(arr.length-1);i>0;i--){
            console.log(((0,date_fns__WEBPACK_IMPORTED_MODULE_0__.compareAsc)(arr[i-1].dueDate,arr[i].dueDate)));

            if(((0,date_fns__WEBPACK_IMPORTED_MODULE_0__.compareAsc)(arr[i-1].dueDate,arr[i].dueDate))==1)
            {
                let c={};
                c=arr[i];
                arr[i]=arr[i-1];
            ...
            else if(((0,date_fns__WEBPACK_IMPORTED_MODULE_0__.compareAsc)(arr[i-1].dueDate,arr[i].dueDate))==0)
            {
